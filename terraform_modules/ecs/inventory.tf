...
# resource "aws_appautoscaling_target" "inventory_target" {
#   max_capacity       = 2
#   min_capacity       = 1
#   resource_id        = "service/${aws_ecs_cluster.ecs_cluster.name}/${aws_ecs_service.inventory_api_service.name}"
#   scalable_dimension = "ecs:service:DesiredCount"
#   service_namespace  = "ecs"
# }

# resource "aws_appautoscaling_policy" "inventory_policy" {
#   name               = "inventory-policy"
#   policy_type        = "TargetTrackingScaling"
#   resource_id        = aws_appautoscaling_target.inventory_target.resource_id
#   scalable_dimension = aws_appautoscaling_target.inventory_target.scalable_dimension
#   service_namespace  = aws_appautoscaling_target.inventory_target.service_namespace
